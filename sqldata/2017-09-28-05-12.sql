...
INDERT INTO one_action(`id`,`name`,`title`,`remark`,`rule`,`type`,`status`,`update_time`) VALUES 
...
INDERT INTO one_action_log(`id`,`action_id`,`user_id`,`action_ip`,`model`,`record_id`,`remark`,`status`,`create_time`) VALUES 
 (2,1,1,2130706433,'member',1,'操作url：/index.php?s=/admin/public/login.html',1,1505704081),
(3,1,1,2130706433,'member',1,'操作url：/index.php?s=/home/user/login.html',1,1505724179),
(4,1,1,2130706433,'member',1,'操作url：/index.php?s=/admin/public/login.html',1,1505724233),
(5,1,1,2130706433,'member',1,'操作url：/index.php?s=/admin/public/login.html',1,1505804267);
...
INDERT INTO one_addons(`id`,`name`,`title`,`description`,`status`,`config`,`author`,`version`,`create_time`,`has_adminlist`) VALUES 
...
(2,'SiteStat','站点统计信息','统计站点的基础信息',1,'{"title":"\u7cfb\u7edf\u4fe1\u606f","width":"1","display":"1","status":"0"}','thinkphp','0.1',1379512015,0),
(3,'DevTeam','开发团队信息','开发团队成员信息',1,'{"title":"OneThink\u5f00\u53d1\u56e2\u961f","width":"2","display":"1"}','thinkphp','0.1',1379512022,0),
(4,'SystemInfo','系统环境信息','用于显示一些服务器的信息',1,'{"title":"\u7cfb\u7edf\u4fe1\u606f","width":"2","display":"1"}','thinkphp','0.1',1379512036,0),
...
INDERT INTO one_attachment(`id`,`uid`,`title`,`type`,`source`,`record_id`,`download`,`size`,`dir`,`sort`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_attribute(`id`,`name`,`title`,`field`,`type`,`value`,`remark`,`is_show`,`extra`,`model_id`,`is_must`,`status`,`update_time`,`create_time`) VALUES 
...
INDERT INTO one_auth_extend(`group_id`,`extend_id`,`type`) VALUES 
 (1,1,1),
(1,1,2),
(1,2,1),
(1,2,2),
...
INDERT INTO one_auth_group(`id`,`module`,`type`,`title`,`description`,`status`,`rules`) VALUES 
...
INDERT INTO one_auth_group_access(`uid`,`group_id`) VALUES 
 (19,1),
(20,1),
(24,2),
(25,2);
...
INDERT INTO one_auth_rule(`id`,`module`,`type`,`name`,`title`,`status`,`condition`) VALUES 
...
INDERT INTO one_category(`id`,`name`,`title`,`pid`,`sort`,`list_row`,`meta_title`,`keywords`,`description`,`template_index`,`template_lists`,`template_detail`,`template_edit`,`model`,`type`,`link_id`,`allow_publish`,`display`,`reply`,`check`,`reply_model`,`extend`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_channel(`id`,`pid`,`title`,`url`,`sort`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_config(`id`,`name`,`type`,`title`,`group`,`extra`,`remark`,`create_time`,`update_time`,`status`,`value`,`sort`) VALUES 
...
INDERT INTO one_document(`id`,`uid`,`name`,`title`,`category_id`,`description`,`root`,`pid`,`model_id`,`type`,`position`,`link_id`,`cover_id`,`display`,`dateline`,`attach`,`view`,`comment`,`extend`,`level`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_document_article(`id`,`parse`,`content`,`template`,`bookmark`) VALUES 
...
INDERT INTO one_document_download(`id`,`parse`,`content`,`template`,`file_id`,`download`,`size`) VALUES 
...
INDERT INTO one_file(`id`,`name`,`savename`,`savepath`,`ext`,`mime`,`size`,`md5`,`sha1`,`location`,`create_time`) VALUES 
...
INDERT INTO one_hooks(`id`,`name`,`description`,`type`,`update_time`,`addons`) VALUES 
...
INDERT INTO one_member(`uid`,`nickname`,`sex`,`birthday`,`qq`,`score`,`login`,`reg_ip`,`reg_time`,`last_login_ip`,`last_login_time`,`status`) VALUES 
 (1,'xlh',0,'0000-00-00','',10,5,0,1505704031,2130706433,1505804267,1);
...
INDERT INTO one_menu(`id`,`title`,`pid`,`sort`,`url`,`hide`,`tip`,`group`,`is_dev`) VALUES 
 (1,'首页',0,0,'Index/index',0,'',,0),
(2,'内容',0,0,'Article/mydocument',0,'',,0),
...
(16,'用户',0,0,'User/index',0,'',,0),
(17,'用户信息',16,0,'User/index',0,'','用户管理',0),
(18,'新增用户',17,0,'User/add',0,'添加新用户',,0),
(19,'用户行为',16,0,'User/action',0,'','用户管理',0),
(20,'新增用户行为',19,0,'User/addAction',0,'"用户->用户行为"中的新增',,0),
(21,'编辑用户行为',19,0,'User/editAction',0,'"用户->用户行为"点击标题进行编辑',,0),
...
(84,'移动',80,0,'Category/move',0,'移动栏目分类',,0),
(85,'合并',80,0,'Category/merge',0,'合并栏目分类',,0),
...
INDERT INTO one_model(`id`,`name`,`title`,`extend`,`relation`,`need_pk`,`field_sort`,`field_group`,`attribute_list`,`template_list`,`template_add`,`template_edit`,`list_grid`,`list_row`,`search_key`,`search_list`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_picture(`id`,`path`,`url`,`md5`,`sha1`,`status`,`create_time`) VALUES 
...
INDERT INTO one_ucenter_admin(`id`,`member_id`,`status`) VALUES 
 (1,1,1);
...
INDERT INTO one_ucenter_app(`id`,`title`,`url`,`ip`,`auth_key`,`sys_login`,`allow_ip`,`create_time`,`update_time`,`status`) VALUES 
...
INDERT INTO one_ucenter_member(`id`,`username`,`password`,`email`,`mobile`,`reg_time`,`reg_ip`,`last_login_time`,`last_login_ip`,`update_time`,`status`) VALUES 
 (1,'xlh','cc5ffb771e818a0d716420b09d5d51e6','2278259541@qq.com','',1505704031,2130706433,1505804267,2130706433,1505704031,1);
...
INDERT INTO one_ucenter_setting(`id`,`type`,`value`) VALUES 
...
INDERT INTO one_url(`id`,`url`,`short`,`status`,`create_time`) VALUES 
...
INDERT INTO one_userdata(`uid`,`type`,`target_id`) VALUES 
