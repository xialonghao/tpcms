<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:26:"./admintpl/adcatelist.html";i:1506586476;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="mt-10">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
						...
						<td>
						<span>
							<input class="btn btn-success radius size-MINI" type="button" onclick="window.location.href='adcateup.html?id=<?php echo $v['id']; ?>'" value="编辑">
						</span>
						<!-- <a href="<?php echo url('Ad/upcate',['id'=>$v['id']]); ?>" title="删除"> -->
							<!-- <input id="del" class="btn btn-danger radius size-MINI" type="button" did="<?php echo $v['id']; ?>" value="删除123"> -->
						<!-- </a> -->
