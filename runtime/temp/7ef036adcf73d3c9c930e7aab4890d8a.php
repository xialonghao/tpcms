<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:24:"./admintpl/userlist.html";i:1506656734;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
					...
					<table class="table table-border table-bordered table-hover">
						...
						<?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?>
			              <tr>
			                ...
			                <td>
								<input class="btn btn-secondary radius size-S" type="button" onclick="window.location.href='userup.html?id=<?php echo $li['id']; ?>'"  value="编辑">
