<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:29:"./admintpl/adcaterecover.html";i:1506519392;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
        ...
        <!-- $('#delete_rule_all').click(function(){ -->
           <!-- var idds=''; -->
            ...
            <!-- if(idds==''){ -->
                <!-- alert('请选择删除内容'); -->
                <!-- location.href="<?php echo url('Ad/adrecovercate'); ?>"; -->
            <!-- } -->
              <!-- idds=idds.substr(0,idds.length-1); -->
            <!-- //alert(idds); -->
             <!-- window.location.href="/admin.php/Ad/deladcate/id/"+idds; -->
        <!-- }); -->
        <!-- $('#check_rule_all').click(function(){ -->
            <!-- if($(this).is(':checked')) { -->
                <!-- $('.ids').prop('checked',true); -->
        ...
        <!-- $('#back_rule_all').click(function(){ -->
           <!-- var idds=''; -->
            ...
            <!-- //alert(idds); -->
             <!-- window.location.href="/admin.php/Ad/rebackcate/id/"+idds; -->
        <!-- }); -->
